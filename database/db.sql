...
-- Create the 'tire_change_history' table 
...
FOREIGN KEY (car_id) REFERENCES cars(id) 
 ...
 -- Create the 'car_maintenance_history' table 
...
FOREIGN KEY (car_id) REFERENCES cars(id) 
 ...
 -- Create the 'oil_change_history' table
CREATE TABLE IF NOT EXISTS oil_change_history ( id INT AUTO_INCREMENT PRIMARY KEY, 
car_id INT NOT NULL,
...
-- Populate 'fueling_history' table
INSERT INTO fueling_history (car_id, fuel_amount, fuel_date, fueling_kilometers) VALUES
(1, 40.25, '2024-01-01', 50500.75),
(2, 35.50, '2024-01-02', 45500.50),
(3, 45.75, '2024-01-03', 60600.00),
(4, 38.00, '2024-01-04', 48400.25),
(5, 42.50, '2024-01-05', 52400.75),
(6, 37.25, '2024-01-06', 55300.50),
(7, 44.00, '2024-01-07', 51300.00),
(8, 36.75, '2024-01-08', 49300.25),
(9, 41.00, '2024-01-09', 53300.50),
(10, 39.50, '2024-01-10', 58300.00);

-- Populate 'tire_change_history' table
...
-- Populate 'car_maintenance_history' table
...
-- Populate 'oil_change_history' table
